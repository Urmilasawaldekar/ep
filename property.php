...
<p style="margin-left:40px"><b>Property Status :</b></p>
        <select name="srproperty" id="srproperty" class="srproperty" required="">
                                ...
                                <p><b>City Name :</b></p>
                                <input class="form-control" type="text" name="location" id="location" required="" placeholder="city name...">
...
<div><h1 class="main" style="color:#1d4052">Properties</h1></div>
<div class="container" style="width:100%">

	 <!-- <form method="POST">
<input type="text" name="search" style="margin-left:800px;margin-top:80px;" onchange="myfunction()"><button name="btn" type="submit" ><i class="fa fa-search" aria-hidden="true"></i></button></form> -->
          <?php  
 ...
 $sql = "SELECT * FROM `property` WHERE type LIKE '%$ptype%' and  property_status LIKE '%$srproperty%' or city_name LIKE '%$location%' 
  ";
...
while($row = mysqli_fetch_assoc($result)) {?>
        ...
        <div class="card-footer">
           <?php echo  " <a href='detail.php?sid= $row[id]'> read more</a>";?>
        </div>
    </div>
<?php }}}?>
</div>
