        ...
        <div class="menu-right">
            ...
            <ul id="menu" >
                <li ><a  href="adminpanel.php">Home</a></li>
                        ...
                        <li><a class="active" href="aproduct.php"> Properties</a></li>
...
<h3 class="main">Properties Details</h3>
...
<td><?php echo $sno++; ?></td>
		...
		<td> <img src="images/Properties/<?php echo $row['img']; ?>" alt="img not found" style=" width: 80px; height: 50px;"></td>
   
<td><?php echo $row['property_status']; ?></td>   
<td><?php echo $row['type']; ?></td>   
<td><?php echo $row['sub_type']; ?></td>   
<td><?php echo $row['area']; ?><?php echo $row['mesurement']; ?></td>   
<td><?php echo $row['owner_name']; ?></td>   
<td><?php echo $row['contact']; ?></td>   
<td><?php echo $row['p_details']; ?></td>   

<td><a class="btn2"  href="apdelete.php?id=<?php echo $row['id']; ?>" >Delete</a></td> 
